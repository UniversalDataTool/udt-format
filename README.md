...
| [data_collection](https://github.com/OpenHumanAnnotation/open-human-annotation-task-format/blob/master/interfaces/data_collection.md)    | Retrieve information from source(s) or the internet.                                              |
